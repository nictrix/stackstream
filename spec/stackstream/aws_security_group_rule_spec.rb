  ...
  context '#my_security_group_rule_ingress_cidr' do
    context '#create' do
      it 'should be the AwsSecurityGroupRule class' do
        expect(my_security_group_rule_ingress_cidr).to be_a(
          Stackstream::AwsSecurityGroupRule
        )
      end
      ...
      it 'should have to_port' do
        expect(my_security_group_rule_ingress_cidr.to_port).to eq(65_535)
      end
      ...
      it 'should have cidr_blocks' do
        expect(my_security_group_rule_ingress_cidr.cidr_blocks).to eq(
          ['0.0.0.0/0']
        )
      end

      it 'should have security_group' do
        expect(my_security_group_rule_ingress_cidr.security_group).to match(
          /sg-.*/
        )
      end
    end
    ...
    context '#destroy' do
      it 'should destroy before create' do
        allow(my_security_group_rule_ingress_cidr).to receive(:state)
          .and_return(
